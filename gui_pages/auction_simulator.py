...
package_valuation_a2 = col_2.number_input("Package Valuation Bidder 1, item 1-2", min_value=0, value=(def_bids_a[0]+def_bids_a[1]))
package_valuation_a3 = col_3.number_input("Package Valuation Bidder 1, item 1-3", min_value=0, value=(def_bids_a[0]+def_bids_a[1]+def_bids_a[2]))
package_valuation_a4 = col_4.number_input("Package Valuation Bidder 1, item 1-4", min_value=0, value=(def_bids_a[0]+def_bids_a[1]+def_bids_a[2]+def_bids_a[3]))
package_valuation_a5 = col_5.number_input("Package Valuation Bidder 1, item 1-5", min_value=0, value=(def_bids_a[0]+def_bids_a[1]+def_bids_a[2]+def_bids_a[3]+def_bids_a[4]))
...
package_valuation_b2 = col_2.number_input("Package Valuation Bidder 2, item 1-2", min_value=0, value=(def_bids_b[0]+def_bids_b[1]))
package_valuation_b3 = col_3.number_input("Package Valuation Bidder 2, item 1-3", min_value=0, value=(def_bids_b[0]+def_bids_b[1]+def_bids_b[2]))
package_valuation_b4 = col_4.number_input("Package Valuation Bidder 2, item 1-4", min_value=0, value=(def_bids_b[0]+def_bids_b[1]+def_bids_b[2]+def_bids_b[3]))
package_valuation_b5 = col_5.number_input("Package Valuation Bidder 2, item 1-5", min_value=0, value=(def_bids_b[0]+def_bids_b[1]+def_bids_b[2]+def_bids_b[3]+def_bids_b[4]))
...
package_valuation_c2 = col_2.number_input("Package Valuation Bidder 3, item 1-2", min_value=0, value=(def_bids_c[0]+def_bids_c[1]))
package_valuation_c3 = col_3.number_input("Package Valuation Bidder 3, item 1-3", min_value=0, value=(def_bids_c[0]+def_bids_c[1]+def_bids_c[2]))
package_valuation_c4 = col_4.number_input("Package Valuation Bidder 3, item 1-4", min_value=0, value=(def_bids_c[0]+def_bids_c[1]+def_bids_c[2]+def_bids_c[3]))
package_valuation_c5 = col_5.number_input("Package Valuation Bidder 3, item 1-5", min_value=0, value=(def_bids_c[0]+def_bids_c[1]+def_bids_c[2]+def_bids_c[3]+def_bids_c[4]))
...
package_valuation_d2 = col_2.number_input("Package Valuation Bidder 4, item 1-2", min_value=0, value=(def_bids_d[0]+def_bids_d[1]))
package_valuation_d3 = col_3.number_input("Package Valuation Bidder 4, item 1-3", min_value=0, value=(def_bids_d[0]+def_bids_d[1]+def_bids_d[2]))
package_valuation_d4 = col_4.number_input("Package Valuation Bidder 4, item 1-4", min_value=0, value=(def_bids_d[0]+def_bids_d[1]+def_bids_d[2]+def_bids_d[3]))
package_valuation_d5 = col_5.number_input("Package Valuation Bidder 4, item 1-5", min_value=0, value=(def_bids_d[0]+def_bids_d[1]+def_bids_d[2]+def_bids_d[3]+def_bids_d[4]))
...
package_valuation_e2 = col_2.number_input("Package Valuation Bidder 5, item 1-2", min_value=0, value=(def_bids_e[0]+def_bids_e[1]))
package_valuation_e3 = col_3.number_input("Package Valuation Bidder 5, item 1-3", min_value=0, value=(def_bids_e[0]+def_bids_e[1]+def_bids_e[2]))
package_valuation_e4 = col_4.number_input("Package Valuation Bidder 5, item 1-4", min_value=0, value=(def_bids_e[0]+def_bids_e[1]+def_bids_e[2]+def_bids_e[3]))
package_valuation_e5 = col_5.number_input("Package Valuation Bidder 5, item 1-5", min_value=0, value=(def_bids_e[0]+def_bids_e[1]+def_bids_e[2]+def_bids_e[3]+def_bids_e[4]))
...
winner_allocation["blocks_won_post_min_check"] = winner_allocation["num_items_won_pre_min_check"]*winner_allocation["meets_min_blocks_won"]
